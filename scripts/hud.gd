...
func _on_sizey_value_changed(value: float) -> void:
	values_changed.emit("size_y", value)


func _on_sizex_value_changed(value: float) -> void:
	values_changed.emit("size_x", value)
